...
class PolicyOptCaffe(PolicyOpt):
    ...
    def __init__(self, hyperparams, dO, dU):
        ...
        self.train_dir = os.path.join(os.path.dirname(self._hyperparams['weights_file_prefix']),
                                      'caffe_train')
        self.snapshot_name = os.path.join(self.train_dir, self._hyperparams['weights_file_prefix'].split('/')[-1])
    ...
    def init_solver(self):
        ...
        solver_param.snapshot_prefix = self.snapshot_name
    ...
    def update(self, obs, tgt_mu, tgt_prc, tgt_wt):
        ...
        for i in range(self._hyperparams['iterations']):
            ...
            if (i+1) % 500 == 0:
                print('===========Caffe iteration %d, average loss %f ==========='%(
