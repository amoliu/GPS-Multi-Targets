...
_SAMPLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='END_EFFECTOR_POINT_TARGET_POSITION', index=20, number=20,
      options=None,
      type=None),
  ],
...
TOTAL_DATA_TYPES = 19
END_EFFECTOR_POINT_TARGET_POSITION = 20
TRIAL_ARM = 0
AUXILIARY_ARM = 1
