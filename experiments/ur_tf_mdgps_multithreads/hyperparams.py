...
agent = {
    ...
    'parallel_on_conditions': False, # If true, multithreads over various conditions
                                     # If false, multithreads over number of samples for each condition
