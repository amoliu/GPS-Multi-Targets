...
EXP_DIR = os.path.dirname(os.path.realpath(__file__)) + '/test_elu/'
...
algorithm['policy_opt'] = {
    ...
    'network_params': {
        ...
        'sensor_dims': SENSOR_DIMS,
        'dim_hidden': [512, 1024, 512],
        'activation_fn': 'elu',
    },
    'network_model': example_tf_network_with_BN,
}
